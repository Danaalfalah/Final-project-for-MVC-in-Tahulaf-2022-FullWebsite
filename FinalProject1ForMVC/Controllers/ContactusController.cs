...
namespace FinalProject1ForMVC.Controllers
{
    public class ContactusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Phone,Email")] Contactu contactu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,Phone,Email")] Contactu contactu)
        {
            if (id != contactu.Id)
            {
                return NotFound();
